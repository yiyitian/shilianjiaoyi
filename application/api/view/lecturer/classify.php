        ...
        <div class="lecture-art" style="padding-top:50px;">
            <table width="94.5%" border="0" cellspacing="0" cellpadding="0" id="grid">
                <tr style="background-color: rgb(245, 245, 245);">
                    <td  style="text-align:center;font-weight:bold;font-size:14px;background: #ded7d4">课程</td>
                ...
                <tr style="background-color: rgb(245, 245, 245);">
                    ...
                    <td  style="text-align:center">{$vo.updatetime|date="y-m-d",###}</td>
                    <td  style="text-align:center"><a href="details?cid={$vo.id}&time={$vo.times}">查看</a></td>
                </tr>
                {/volist}
            </table>
        </div>
