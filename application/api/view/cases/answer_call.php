    ...
    <section class="aui-flexView">
        <div class="header">
            <div class="box">
                ...
                <div class="C"><p>电话接听</p></div>
                {notempty name="isAdd"}
                <div class="R" style="position: absolute;right: 10px;top: 0;color: #fff;line-height: 39px;" id="add"><p>添加电话接听</p></div>
                {/notempty}
            </div>
        </div>
        ...
        <table width="94.5%" border="0" cellspacing="0" cellpadding="0" id="grid">
            ...
            {volist name="list" id="vo" empty="<div style='width:100%;text-align:center'>暂无数据</div>"}
                <tr style="background-color: rgb(245, 245, 245);">
                    ...
                    <td  style="text-align:center">{$vo.manager}</td>
                    <td  style="text-align:center"><a href="callDetail?id={$vo.id}">查看</a></td>
                </tr>
            {/volist}
        </table>
    </div>
