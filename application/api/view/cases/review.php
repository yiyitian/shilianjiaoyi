...
<div class="body-container">
    <div class="header">
        <div class="box">
            ...
            <div class="C"><p>客户回访</p></div>
            {notempty name="isAdd"}
            <div class="R" style="position: absolute;right: 10px;top: 0;color: #fff;line-height: 39px;" id="add"><p>添加回访</p></div>
            {/notempty}
        </div>
    </div>
            ...
            <table width="94.5%" border="0" cellspacing="0" cellpadding="0" id="grid">
                {notempty name="list"}
                    <tr style="background-color: rgb(245, 245, 245);">
                        <td  style="text-align:center;font-weight:bold;font-size:14px;background: #ded7d4">时间</td>
                ...
                <tr style="background-color: rgb(245, 245, 245);">
                    <td  style="text-align:center">{$vo.enquirytime|default="无"}</td>
                    <td  style="text-align:center">{$vo.salesman}</td>
                    <td  style="text-align:center"><a href="reviewDetail?id={$vo.id}">查看</a></td>
                </tr>
                {/volist}
            </table>
        </div>
