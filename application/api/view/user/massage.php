...
<section class="aui-flexView ">
    ...
    <section class="aui-scrollView aui-tab" data-ydui-tab>
        <div class="aui-form-search b-line" style="padding-top:50px;">
        ...
        <div class="tab-panel">
            ...
            <div class="tab-panel-item tab-active">
                ...
                <a href="/api/index/details?id={$dd.id}" class="aui-news-item b-line" style="width: 100%;float:left;line-height: 30px;display: block;padding: 5px 10px">
