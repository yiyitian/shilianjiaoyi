...
<body>
    ...
    <div style="padding: 15px;">
        ...
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;display: none;">
            <legend>本项目中的人员信息</legend>
        </fieldset>
        <table class="layui-hide"  lay-filter="posts" id="posts" style=""></table>
    ...
    layui.use(['table','layer','jquery'], function(){
        ...
        var renderTable = function() {
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'title', align: 'center', title: '周报起始时间'}
        ...
        var renderPostTable = function() {
            table.render({
                ...
                , title: '项目：{$name}-人员信息'
                , elem: '#posts'
                , url: 'project_postsinfo?pro_id={$pro_id}'
                , width: 500
                , page: false
                , cols: [[
                    {type: 'numbers', title: 'No.'}
                    , {field: 'station', align: 'center', title: '职位'}
                    , {field: 'num', align: 'center', title: '人数'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                layer.confirm('确定删除吗', function(index){
                    $.ajax({
                        url: "weekinfo_del" ,
                        data: {'times':data.times,'pro_id':{$pro_id}},
                        type: "post" ,
                        dataType:'json',
