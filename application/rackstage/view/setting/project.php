...
<script type="text/html" id="checkboxTp2">
    <input type="checkbox" name="status1" value="{{d.status1}}" lay-skin="switch" lay-text="推荐|隐藏" lay-filter="sexDemo" {{
           d.status1== 1 ? 'checked' : '' }}>
</script>
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        <div class="demoTable">
            ...
            <button class="layui-btn"  id="tel">添加播报</button>
    ...
    layui.use(['table','layer','jquery'], function(){
        ...
        var renderTable = function(){table.render({
            ...
            ,cols: [[
                ...
                ,{field:'status1', align:'center', title:'推荐', width:110, templet: '#checkboxTp2', unresize: true,event:'is_status'}
