		...
		var renderTable = function(){
			table.render({
				...
				,cols: [[
                    ...
                    ,{field:'project_title',width:100, align:'center',  title: '项目名称'}
                    ,{field:'username',width:120,  align:'center',  title: '姓名'}
                    ,{field:'title',width:120,  align:'center',  title: '标题'}
					,{field:'content',  align:'center',   title: '下周计划'}
                     ,{field:'create_at', align:'center', width:220,   title: '日期'}
