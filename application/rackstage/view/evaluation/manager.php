...
{/in}
            <button class="layui-btn" style="background: grey"
                    onclick="window.location.href='manager?history=1'">历史打分</button>
            {in name='jurisdiction' value='1'}
            <button class="layui-btn" id="create_table">一键刷新</button>
            {/in}
        </div>
        <table class="layui-table"
               lay-data="{height:'',url:'manager?id=1', page:{ layout: ['limit', 'count', 'prev', 'page', 'next', 'skip'] ,curr: 1 , limit: 10  , limits: [5,10,15,20,25,30,35,40, 50, 100] , groups: 5 , first: '首页', last: '尾页' }, id:'test',cellMinWidth:120}"
               lay-filter="test">
            <thead>
            <tr>
                ...
                <th lay-data="{field: 'subscribe_score', align: 'center',width:150,edit:'text'}">认购完成得分</th>
                <th lay-data="{field: 'authenticity', align: 'center',width:150,edit:'text'}">真实性得分</th>
                <th lay-data="{field: 'profit', align: 'center',width:150}">理论利润</th>
                <th lay-data="{field: 'profit_score', align: 'center',width:150,edit:'text'}">理论利润得分</th>
                <th lay-data="{field: 'develop_costume', align: 'center',width:150,edit:'text'}">蓄客完成得分</th>
                <th lay-data="{field: 'work_book_score', align: 'center',width:150,{eq name='jurisdiction' value='1'}edit:'text'{/eq}}">计划书</th>
