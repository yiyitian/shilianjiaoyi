...
<!--            </div>-->
            ...
            {/eq}
            <button class="layui-btn"  type="button"  style="background: #808080" onclick="window.location.href='plans?history=1'">历史打分
            </button>
        </div>
        </form>
        ...
        <script type="text/html" id="barDemo">
            {eq name="jurisdiction" value="1"}<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="pass">通过</a>{/eq}<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a></script>
...
//                ids = layui.formSelects.value('select7_3', 'val'),
            ...
            if(status1>0)
            {
                table.render({
                    ...
                    ,toolbar:true
                    ,elem: '#test'
                    ,url:'/rackstage/plan/getProject?project='+project+'&date='+date+'&status=1'
                    ...
                    ,cols: [[
                        ...
                        ,{field: 'project_title',width:150, align: 'center',width:150,title:'项目名称'}
                        ,{field: 'username',width:150, align: 'center',width:150,title:'业务员'}
                        ,{field: 'subscribe_rate',width:150, align: 'center',title:'认购完成率'}
                        ,{field: 'subscribe_real',width:150, align: 'center',title:'认购完成得分',templet:'#subscribe_real',{in name='jurisdiction' value='1'}edit: 'text'{/in}}
                        ,{field: 'visiting_aims', width:150,align: 'center',title:'月来访目标',{in name='jurisdiction' value='1,2'}edit: 'text'{/in}}
                        ,{field: 'visiting',width:150, align: 'center',title:'月来访人数',{in name='jurisdiction' value='1,2'}edit: 'text'{/in}}
                        ,{field: 'visiting_score',width:150, align: 'center',title:'月来访得分', {in name='jurisdiction' value='1,2'}edit: 'text'{/in},templet:'#visiting_score'}
            ...
            ,{ width:150, align:'center',width:150, toolbar: '#barDemo',title:'操作'}
                        ]]
                    });
            }else{
                    table.render({
                        ...
                        ,cols: [[
                            ...
                            ,{field: 'develop_costume',width:150, align: 'center',title:'蓄客得分',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                            ,{field: 'work_book_score',width:150, align: 'center',title:'计划书',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                            ,{field: 'xukecount', width:150,align: 'center',title:'蓄客总分'}
                            {eq name="jurisdiction" value='1'}
                            ,{field: 'subsidy',width:150, align: 'center',title:'补助'}
                            ,{field: 'admin_id',width:150,align: 'center',title:'状态',templet:'#adminTpl'}
                            {/eq}
        ...
        var renderTable=function(){
            table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'subscribe_rate',width:150, align: 'center',title:'认购完成率'}
                    {eq name="jurisdiction" value='1,2'}
                    ,{field: 'subscribe_real',width:150, align: 'center',title:'认购完成得分',templet:'#subscribe_real',{in name='jurisdiction' value='2,1'}edit: 'text'{/in}}
                     ,{field: 'visiting',width:150, align: 'center',title:'月来访人数',{in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;'}
                    {/eq}
                    ,{field: 'visiting_aims',width:150, align: 'center',title:'月来访目标',{in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;'}
                    ,{field: 'visiting_score', width:150,align: 'center',title:'月来访得分', {in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;',templet:'#visiting_score'}
                    ,{field: 'visiting_real_score', width:150,align: 'center',title:'系统检查得分'}
                    ,{field: 'profit', width:150,align: 'center',title:'理论利润'}
                    ,{field: 'profit_score',width:150, align: 'center',title:'理论利润得分',templet:'#profit_score',{in name='jurisdiction' value='1'}edit: 'text'{/in}}
    {/eq}
    {eq name="project_status|default=-1" value="-1"}
                    ,{field: 'customers_biao',width:150, align: 'center',title:'蓄客目标',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                    ,{field: 'customers_number',width:150, align: 'center',title:'蓄客数量',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                    ,{field: 'develop_costume',width:150, align: 'center',title:'蓄客得分',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                    ,{field: 'work_book_score',width:150, align: 'center',title:'计划书',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}
                    ,{field: 'xukecount',width:150, align: 'center',title:'蓄客总计'}
                     {/eq}
    {eq name="project_status|default=1" value="1"}

    ,{field: 'total', align: 'center',title:'总计'}
                    ,{field: 'total_real', align: 'center',width:150,title:'系统检查总分'}
    {/eq}
                    {eq name="jurisdiction" value='1'}
