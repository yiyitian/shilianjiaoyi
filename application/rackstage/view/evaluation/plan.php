...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        ...
        <table class="layui-table" lay-data="{height:'',url:'plan?id=1', page:{ layout: ['limit', 'count', 'prev', 'page', 'next', 'skip'] ,curr: 1 , limit: 10  , limits: [5,10,15,20,25,30,35,40, 50, 100] , groups: 5 , first: '首页', last: '尾页' }, id:'test',cellMinWidth:120}"
               lay-filter="test">
            <thead>
            <tr>
                ...
                {eq name="project_status|default=1" value="1"}
                    ...
                    <th lay-data="{field: 'subscribe_real', align: 'center',{in name='jurisdiction' value='1'}edit: 'text'{/in},style:'font-weight:600;',templet:'#subscribe_real'}">
                        认购完成得分
                    </th>

                    <th lay-data="{field: 'visiting_aims', align: 'center',{in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;'}">
                        月来访目标
                    </th>
                    <th lay-data="{field: 'visiting', align: 'center',{in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;'}">月来访人数</th>

                
                    <th lay-data="{field: 'visiting_score', align: 'center', {in name='jurisdiction' value='1,2'}edit: 'text'{/in},style:'font-weight:600;background-color: lightskyblue;',templet:'#visiting_score'}">
                        月来访得分
                    </th>

                    <th lay-data="{field: 'visiting_real_score', align: 'center'}">系统检查得分</th>
                    <th lay-data="{field: 'profit', align: 'center'}">理论利润</th>
                <th lay-data="{field: 'profit_score',templet:'#profit_score', align: 'center',style:'font-weight:600;',edit:'text'}">理论利润得分</th>

                {eq name='jurisdiction' value='1'}

                <th lay-data="{field: 'develop_costume', align: 'center'}">蓄客得分</th>
                    <th lay-data="{field: 'work_book_score', align: 'center',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}">计划书</th>
                    {/eq}
                {else/}
<!--                     <th lay-data="{field: 'develop_costume', align: 'center'}">蓄客目标</th>
 -->                    <th lay-data="{field: 'customers_number', align: 'center',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}">蓄客数量</th>
                    <th lay-data="{field: 'develop_costume' , align: 'center',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}">蓄客得分</th>
                    <th lay-data="{field: 'work_book_score', align: 'center',{in name='jurisdiction' value='1,2'}edit:'text'{/in}}">计划书</th>
                {/eq}
                {in name="jurisdiction" value="1,2"}
                <th lay-data="{field: 'total', align: 'center',style:'font-weight:600'}">总计</th>
                <th lay-data="{field: 'total_real', align: 'center',style:'font-weight:600'}">系统检查总分</th>
                {/in}
                {eq name="jurisdiction" value='1'}
