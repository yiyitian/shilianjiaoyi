...
<form class="layui-form" action="" id="formid"  style="margin-top: 20px;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="framework_id" id="framework_id" placeholder="请输入所属部门" lay-filter="framework_id">
                <option></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="user_id" id="user_id" placeholder="请输入项目负责人" lay-filter="user_id" lay-search>
				<option></option>
                <option value='1' select>此为默认选项，若有负责人，联系管理员删除此项</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="manager" id="manager" placeholder="请选择项目经理" lay-filter="manager" lay-search>
				<option></option>
                <option value='1' select>此为默认选项，若有项目经理，联系管理员删除此项</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="name" name="name" lay-verify="required" value="{$info.posts|default=''}" placeholder="请输入项目名称" autocomplete="off" class="layui-input">
        </div>
    </div>
      <div class="layui-form-item">
        <label class="layui-form-label">目标</label>
        <div class="layui-input-inline">
            <input type="number" id="aims" name="aims" lay-verify="required" value="{$info.aims|default=''}" placeholder="请输入目标" autocomplete="off" class="layui-input">
        </div>
    </div>
         <div class="layui-form-item">
        <label class="layui-form-label">项目类型</label>
        <div class="layui-input-block">
        {if condition="isset($info)&&($info.type eq 1)"}
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
        {if condition="isset($info)&&($info.is_agent eq -1)"}
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">是否考评项目</label>
        <div class="layui-input-block">
		{if condition="isset($info)&&($info.is_assessment eq '-1')"}
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入备注内容" class="layui-textarea" name="mark" style="width:80%">{$info.mark|default=''}</textarea>
        </div>
    </div>
</form>
...
<script>
    ...
    layui.use(['layer', 'form','element','jquery'], function(){
        ...
        function verifycontent() {
            ...
            if($('#manager').val()==""){ layer.alert($('#manager').attr('placeholder'));  return false;};
