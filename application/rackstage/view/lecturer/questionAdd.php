   ...
   <!--  <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            {notempty name="list"}
                ...
                <input type="radio" name="is_choose" value="-1" title="多选题" {if condition="isset($list.is_choose)&&($list.is_choose eq -1)"}checked{/if}>
            {else /}
                <input type="radio" name="is_choose" value="1" title="选择题" checked>
                <input type="radio" name="is_choose" value="-1" title="多选题" >
            {/notempty}
        </div>
    </div> -->
   

               <input type="hidden"  id="question"  name="cid" value="{$list.cid|default=$cid}"  placeholder="请输入内容" class="layui-input">
    ...
    <div class="layui-form-item xuanze">
        ...
        <div class="layui-input-inline">
            <input type="text"  id="true_option"  name="true_option" value="{$list.true_option|default=''}"  placeholder="单选请直接输入选项，多选请用英文逗号隔开" class="layui-input"  >
        </div>
    </div>
