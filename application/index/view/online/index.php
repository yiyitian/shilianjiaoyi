...
<div id="mescroll" style="bottom:40px;" class="mescroll news_k">
    ...
    <ul id="newsList" class="news-list">
        ...
        <li>
            ...
            <p><span style="display:inline-block;overflow:hidden;max-width:200px">{$vo.classname_name}</span>
...
<script type="text/javascript" charset="utf-8">
    $(function(){
        ...
        function setListData(curPageData, isAppend) {
            ...
            if(curPageData.length == 0&&document.getElementById("newsList").innerHTML==''){
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                var string = '';
                    string+= '<h1><img src="/public/index/images/news3.jpg"></h1>';
                    string+= '<p>'+newObj.title;
                    if(newObj.is_outline=='线上课程'){
                        string+= '<a href="Detail?outline=-1&id='+newObj.id+'"><span style="float:right;display: inline-block; background: #e28d00;text-align: center; padding: 0.08rem 0;width: 1rem;border-radius: 3px;color: #fff;">去学习</span></a>';
                        string+= '</p><h2>';
                    }else{
                        string+= '<a href="Detail?outline=1&id='+newObj.id+'"><span style="float:right;display: inline-block; background: #e28d00;text-align: center; padding: 0.08rem 0;width: 1rem;border-radius: 3px;color: #fff;">写心得</span></a>';
                        string+= '</p><h2>班主任:';
                    }

                    console.log(newObj);
                    string+= newObj.usersname+' &nbsp;&nbsp;&nbsp;<span style="float:right;padding-top:5px;">时间:'+newObj.startdate+'~'+newObj.enddate+'</span></h2>';
