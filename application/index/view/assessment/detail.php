    ...
    {volist name="infoList" id="vo"}
        <div class="layui-form-item" style="background:#fff;">
            ...
            <div class="layui-input-block" style="margin-left:0;width:90%;margin-left:5%;padding-bottom:15px;">
                <li {if condition="isset($answer)&&($vo['true_option'] eq 'A')"}style="color:green"{/if} ><input type="radio" name="{$vo.id}" value="A" title="{$vo.option_a}" {if condition="isset($answer)&&($answer[$vo['id']] eq 'A')"} checked="" {/if}></li>
