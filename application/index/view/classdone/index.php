...
<div id="mescroll" style="bottom:40px;" class="mescroll news_k">
    ...
    <ul id="newsList" class="news-list">
        <!--        <li>-->
        <!--            <a href="dianfu_news_xq.html">-->
        <!--                <h1><img src="/public/index/images/news3.jpg"></h1>-->
        <!--                <p>青岛至杭州一趟高铁着火 京沪高铁部分停运</p>-->
        <!--                <h2>日期：2018-01-24</h2>-->
        <!--            </a>-->
        <!--        </li>-->
    </ul>
    ...
    $(function(){
        ...
        function setListData(curPageData, isAppend) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                var string = '';
                if(newObj.is_online !==1)
                {
                    string+= '<a href="/index/Online/Detail?timely=1&id='+newObj.cid+'">';
                }else{
                    string+= '<a href="/index/Online/Details?timely=1&id='+newObj.id+'">';
                }
                string+= '<p>'+newObj.title+'</p>';
                string+= '<h2>类型：'+newObj.pid+'</h2></a>';
