...
<style type="text/css">
    * {
    ...
    .news-list .new-content{
        font-size: 14px;        margin-top: 6px;        margin-left: 10px;        color: #666;}
</style>
...
<div class="toub_beij toub_beij_zhuy">
    ...
    <div class="mingc_tb">培训通知列表</div>
    <div class="sy_zaix"><a href="javascript:;" style="color:#e28d00" ><span id="anq_tuic">保存</span></a></div>
</div>
...
<!--                <div class="haoma">-->
<!--                    <p>号码：D15784564102</p>-->
<!--                    <h1><em>￥:560.45</em><i>第 <i>1</i> 期</i></h1>-->
<!--                </div>-->
<!--                <div class="huank">-->
<!--                    <a href="#">去还款</a>-->
<!--                    <span>到期日：2018-01-19</span>-->
<!--                </div>-->
<!--            </li>-->
        </ul>
    </div>
...
<script type="text/javascript" charset="utf-8">
    $(function(){
        ...
        function upCallback(page) {
            $.ajax({
                url: 'Message?num=' + page.num + "&size=" + page.size, //如何修改page.num从0开始 ?
        ...
        function setListData(curPageData, isAppend) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                var str =  ' <div class="haoma"><p>'+(i+1)+'、'+newObj.title+'</p>';
                    str+= '<h1><em>班主任:'+newObj.username+'</em><br>时间:'+newObj.startdate+'~'+newObj.enddate+'</i></h1></div>';
                    if(newObj.is_outline=='线上课程'){
                        str+= '<div class="huank"><a href="/index/Online/Detail?id='+newObj.id+'">去学习</a></div>';
                    }
